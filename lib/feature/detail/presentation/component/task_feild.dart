              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    if (leadingIcon != null) sdsSBWidth10,
                  ...
                  child: Row(
                    children: [
                      if (leadingIcon != null) ...[
                        ...
                        UtilWidget.sizedBoxWidth10(context),
                      ],
                      TextUtils(
                        text: label,
                        availableStyle: StyleEnum.t14Bold,
...
class IconLeadingBottomSheetField<T> extends TaskField {
  ...
  Widget _buildValue(T item, BuildContext context) {
    ...
    return Row(
      ...
      children: [
        if (showAbbreviation && abbreviation.isNotEmpty) ...[
          ...
          UtilWidget.sizedBoxWidth5(context),
        ],
        Flexible(
          child: TextUtils(
              text: title,
          ...
          children: [
            ...
            Expanded(
              child: Align(
                ...
                child: value != null
                    ? _buildValue(value as T, context)
                    : TextUtils(
                        text: hintText ?? '',
            ...
            child: Row(
              children: [
                TextUtils(
                  ...
                  color: AppColors.colorBlack,
                  fontWeight: FontWeight.bold,
                  size: fontSize ?? AppDimens.fontMedium(context),
                ),
                UtilWidget.sizedBoxWidth5(context),
                if (isRequired)
                  TextUtils(
                    ...
                    color: AppColors.redDark,
                    fontWeight: FontWeight.bold,
                    size: AppDimens.fontSmall(context),
                  ),
              ],
            ),
          )
      ...
      case Axis.horizontal:
        return Row(
          children: [
            ...
            UtilWidget.sizedBoxWidth5(context),
            Expanded(flex: 2, child: buildField(context)),
          ],
        );
    }
  }
